...
TextTheme _buildTextTheme(TextTheme original) {
  return original
      .copyWith(
        ...
        displayLarge: _buildTextStyle(Colors.green),
        //Very, very large text.
        displayMedium: _buildTextStyle(Colors.green),
        //Very large text.
        displaySmall: _buildTextStyle(Colors.green),
        //Large text.
        headlineMedium: _buildTextStyle(Colors.green),
        //Used for large text in dialogs
        //(e.g., the month and year in the dialog shown by showDatePicker)
        headlineSmall: _buildTextStyle(Colors.green),
        //Used for the primary text in app bars and dialogs
        //(e.g., AppBar.title and AlertDialog.title).
        titleLarge: _buildTextStyle(Colors.purple),
        //Used for the primary text in lists (e.g., ListTile.title)
        //and the TextField edited text.
        titleMedium: _buildTextStyle(Colors.amber),
        //For medium emphasis text that's a little smaller than subtitle1
        titleSmall: _buildTextStyle(Colors.cyan),
        //Used for emphasizing text that would otherwise be bodyText2.
        bodyLarge: _buildTextStyle(Colors.blue),
        //The default text style for material.
        //Color for ListTile.trailing
        bodyMedium: _buildTextStyle(Colors.green),
        //Used for auxiliary text with images.
        //Used for ListTile.subtile
        bodySmall: _buildTextStyle(Colors.green),
        //Used for text on ElevatedButton, TextButton, and OutlinedButton
        //if no others
        labelLarge: _buildTextStyle(Colors.green),
      )
      .apply(
        fontFamily: 'Rubik',
